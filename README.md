...
Used in 3DGS_Alignment project to scale and transform Gaussian splats. 
The transformations are obtained from [3DGS_Alignment](https://github.com/RishabhBajaj25/3DGS_Alignment) project
